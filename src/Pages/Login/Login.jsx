  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="card max-w-[450px] mx-auto w-full bg-base-100 md:border-2 border-[#6a2881] md:p-4">
          <h1 className="text-4xl font-bold text-center">Login</h1>
          <form onSubmit={handleLogin} className="card-body p-0 md:p-4 pt-2">
